...
public class ConstantsUI {
    ...
    public static final String PATH_LOGO = "/img/LogoPista.png";
    public static final String PATH_BUTTON_ADD = "/img/addFile.png";
    public static final String PATH_GIF = "/img/testgif.gif";
